						...
						<div class="row-fluid">
							...
							<div class="span6 errorBlocks">
								<div class="span8 errorMessage"> 
									<p class="lead text-error">Registration failed</p>
									<p class="text text-error">Maybe you forgot to fill out all input fields or passwords don´t match!</p>
									<p class="text text-error">Please try again...</p>
								</div>	
							</div>
							<div class="span3"></div>
						</div>
