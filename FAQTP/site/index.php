	...
	<div class="row-fluid top-buffer">
		...
		<div class="span4" align="center">
			<table frame="void" border="1">
				<tr align="center">
					<td width="60px">
						<!-- Calling Modal for Login and Registration --> <?php  
					...
					<td width="60px"><a href="#" id="aboutPopover"
						class="headerLinks btn-links" rel="popover"
						data-placement="bottom" data-html="true" data-content="<strong>
						FAQ Manager</strong><br />No Rights Reserved!!!"
							data-original-title="About">About</a></td>
				</tr>
			</table>
